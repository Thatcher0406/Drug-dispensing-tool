...
if (isset($_POST["register-button"])) {
    ...
    $register_query = "INSERT INTO contracts (contractID,pharmaceutical,pharmacy,startdate,enddate,supervisor,text) 
    VALUES ('$contractID','$pharmco','$pharmacy','$startdate','$enddate','$supervisor','$text')";
...
<html>
    ...
    <body>
         ...
         <form action="" method="POST">
			...
			<input type="reset">
			<input type="submit" id="register-button" name="register-button" value = "Submit">
</body>
</html>
