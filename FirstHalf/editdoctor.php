...
if(isset($_POST["update"])){
    ...
    $sql="UPDATE doctors SET docSSN='$docSSN', firstname='$firstname',lastname='$lastname',emailaddress='$emailaddress',password='$password',phone='$phone',yearsofexperience='$yearsofexperience',gender='$gender',specialty='$specialty',extrainfo='$extrainfo' ";
