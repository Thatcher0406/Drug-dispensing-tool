...
if(isset($_POST["update"])){
    ...
    $sql="UPDATE patients SET SSN='$SSN',firstname='$firstname',lastname='$lastname',emailaddress='$emailaddress',Password='$Password',dateofbirth='$dob',Gender='$Gender',Illness='$Illness',primary_physician='$primary_physician',phone='$phone',address='$address',extrainfo='$extrainfo'";
...
<html>
    ...
    <label for="firstname">First Name:</label><br>
        ...
        <label for="extrainfo">Extra Information:</label><br>
        <input type="text" id="extrainfo" name="extrainfo"><br>
